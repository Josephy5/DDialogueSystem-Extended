...
This project is a modified version of DoublSB's D'Dialogue System ([Original GitHub Repository](https://github.com/DoublSB/UnityDialogAsset/tree/master)), a simple dialogue system that uses C# Code to create and play dialogues. These modifications help to make the system more usable for broader use, including 3D games and re-triggerable dialogues. 
